...
App.loadBundle("input-shims.js", ["exports", "./chunk-e404d330.js"], function (t, e) { window.App.h; var n = "$ionRelocated"; function o(t, e, o, i) {
    ...
    if (t[n] !== o) {
        if (e.value, o) {
            !function (t, e) { var n = t.parentElement, o = t.ownerDocument; if (t && n) {
                ...
                (_b = u_1.classList).add.apply(_b, Array.from(e.classList)), u_1.value = e.value, u_1.type = e.type, u_1.placeholder = e.placeholder, u_1.tabIndex = -1, a_1.appendChild(u_1), n.appendChild(a_1), t.style.pointerEvents = "none";
    ...
    return; var o = n[a]; o && clearTimeout(o), e > 0 ? n.style.paddingBottom = e + "px" : n[a] = setTimeout(function () { n.style.paddingBottom = ""; }, 120); } var u = !0, d = !0; t.startInputShims = function (t, e) { var n = e.getNumber("keyboardHeight", 290), s = e.getBoolean("scrollAssist", !0), a = e.getBoolean("hideCaretOnScroll", !0), f = e.getBoolean("inputBlurring", !0), p = e.getBoolean("scrollPadding", !0), m = new WeakMap, v = new WeakMap; function E(t) { var e = t.querySelector("input"), r = t.closest("ion-scroll"), c = t.closest("ion-content"); if (e) {
    if (d && r && a && !m.has(t)) {
